...
def numberOfMonthsWithRaise():
    """How many months it will take to save up enough money for a dwon payment with half yearly raise"""
    ...
    #TODO when total month is odd number it return 1 less value ??
    while portion_down_payment >= current_savings:
        number_of_months += 1
